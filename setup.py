...
#                      "mpl_toolkits.basemap"],
  version           = "0.1",
  description       = "Useful toolkit for analysis and visualization weather, climate, and ocean data.",
  long_description  = """ This is a toolkit for analysis and visualization weather, climate, and ocean data.  It is not a package which creates graphics or plots, but rather helps augment such packages.  In this toolkit, users will find routines which rotate grid relative winds to earth relative, generate color tables, identify corners for plotting regions, convert units, etc. """,
